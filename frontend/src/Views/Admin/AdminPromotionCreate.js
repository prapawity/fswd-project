...
const AdminPromotionCreate = (props) => {
    ...
    const [newPromotion, setPromotion] = useState({productName:"", productID:"",price:"", name: "", discount: null, limit: null})
    ...
    const query = useQuery(PRODUCT_FILTER_QUERY,{variables:{name:newPromotion.productName}})
    ...
    const handleCreate = useCallback(
        async (e) => {
            e.preventDefault()
            try{
                newPromotion.price=(parseFloat(query.data.product.price)*(100-newPromotion.discount)/100).toString()
                                ...
                                <form onSubmit={handleCreate}>
                                    <div className="relative w-full mb-3">
                                        ...
                                        <input
                                            ...
                                            name="name" value={newPromotion.name} placeholder="promotion name" onChange={handleInputChange}
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <input
                                            type="text"
                                            className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                            name="productName" value={newPromotion.productName} placeholder="product name" onChange={handleInputChange}
                                            style={{ transition: "all .15s ease" }}
                                        />
                                    </div>
                                    <div className="relative w-full mb-3">
                                        ...
                                        <input
                                            type="number"
                                            className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                            name="discount" value={newPromotion.discount} placeholder="discount" onChange={handleInputChange}
                                            min="1"
                                            max="100"
                                            style={{ transition: "all .15s ease" }}
                                        />
                                    ...
                                    <div className="relative w-full mb-3">
                                        ...
                                        <input
                                            type="number"
                                            className="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                            name="limit" value={newPromotion.limit} placeholder="limit" onChange={handleInputChange}
                                            min="1"
                                            style={{ transition: "all .15s ease" }}
                                        />
                                    </div>
