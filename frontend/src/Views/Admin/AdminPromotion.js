...
const AdminPromotion = (props) => {
    const header = ["promotion name","product name","full price", "promo price", "discount", "limit"," "]
            ...
            <div className="rounded-t mb-0 px-4 py-2 border-0 widt">
              <div className="flex flex-wrap items-center">
                ...
                <Link to="/admin/promotion/create">
                  <button  className={"bg-gray-500 active:bg-gray-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-5 py-2 rounded outline-none focus:outline-none  ease-linear transition-all duration-150"}>
